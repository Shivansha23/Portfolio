      ...
      <div className="max-w-xl w-full text-center relative">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 px-4">
          <a href="/" className="w-full sm:w-auto">
            <button className="w-full bg-gradient-to-r from-[#E1A940] to-[#FF6700] hover:from-[#FF6700] hover:to-[#E1A940] text-white px-6 py-3 text-base sm:text-lg shadow-md hover:shadow-lg transition-all duration-300 rounded-md">
              Go Home
            </button>
          </a>
          <a href="mailto:shivanshapathak23@gmail.com" className="w-full sm:w-auto">
            <button className="w-full border border-[#1A6262] text-[#1A6262] hover:bg-[#1A6262] hover:text-white px-6 py-3 text-base sm:text-lg bg-transparent rounded-md transition-all duration-300">
              Contact Support
            </button>
          </a>
        </div>
